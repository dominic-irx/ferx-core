...
| `vi_omega_update` | `closed_form` | `closed_form` sets Ω to its exact ELBO maximizer each iteration, keeping it out of the stochastic optimization entirely; `adam` steps it by gradient descent, reproducing the published behaviour. |
